...
const SUBJECT_DATA = {
  ...
  beijing: {
    ...
    categories: [
      ...
      { id: "policy", name: "政策与战略" },
      { id: "transport", name: "交通运输" },
      { id: "culture", name: "文化与休闲" }
    ],
    facts: [
      { title: "定位与区划", cat: "history", content: "北京位于华北平原北部，总面积 1.641 万平方公里，下辖 16 个区。2025 年末常住人口 2180.0 万人，城镇化率 88.3%。" },
      { title: "一核两翼格局", cat: "policy", content: "\"一核\"为首都功能核心区（东城、西城），承载政治、文化、国际交往中心功能；\"两翼\"为北京城市副中心（通州）和河北雄安新区。" },
      { title: "四个中心定位", cat: "policy", content: "北京全国政治中心、文化中心、国际交往中心、科技创新中心。2026 年为\"十五五\"规划开局之年，锚定 2035 年率先基本实现社会主义现代化。" },
      { title: "2026经济与减量发展", cat: "policy", content: "2026 年 GDP 增长预期 5% 左右，经济总量突破 5 万亿元；城乡建设用地规模减量约 50 平方公里，走减量背景下超大城市转型新路。" },
      { title: "科技创新核心指标", cat: "policy", content: "全社会研发投入占比 6% 以上；独角兽企业数量居全国城市首位；较 2020 年高价值发明专利、专精特新\"小巨人\"企业数量翻番；形成 3 个万亿级和 7 个千亿级产业集群。" },
      { title: "绿色北京与公园城市", cat: "policy", content: "PM2.5 年均浓度连续五年稳定达标，2026 年力争降至 29 微克/立方米左右；已创建全域国家森林城市，公园总数 1136 个。" },
      { title: "文化中心建设", cat: "policy", content: "北京中轴线历时 12 年成功申遗；大运河、长城、西山永定河三条文化带建设推进；全球唯一\"双奥之城\"，演艺之都、博物馆之城、书香京城建设成效显著。" },
      { title: "2030年发展目标", cat: "policy", content: "GDP 年均增速 4.5%—5%；全员劳动生产率约 58 万元/人；城镇调查失业率 5% 以内；人均预期寿命 83.9 岁以上。" },
      ...
      },
{
        ...
        options: ["2153.6万", "2180.0万", "2183.2万", "2189.3万"],
        answer: "B",
      ...
      },
{
        ...
        options: ["东城、西城", "通州城市副中心、雄安新区", "朝阳、海淀", "大兴、顺义"],
        answer: "B",
      ...
      },
{
        ...
        options: ["全国政治中心", "全国文化中心", "国际交往中心", "全国科技创新中心"],
        answer: ["A", "B", "C", "D"],
      ...
      },
{
        ...
        options: ["3个万亿级产业集群", "7个千亿级产业集群", "5个万亿级产业集群", "10个千亿级产业集群"],
        answer: ["A", "B"],
      ...
      },
{
        ...
        options: ["800个", "1000个", "1136个", "1500个"],
        answer: "C",
      ...
      },
{
        ...
        categoryName: "政策与战略",
        question: "北京三条文化带包括？",
        options: ["大运河文化带", "长城文化带", "西山永定河文化带", "潮白河文化带"],
        answer: ["A", "B", "C"],
      ...
      },
{
        ...
        options: ["\"十四五\"规划", "\"十五五\"规划", "\"十三五\"规划", "\"十一五\"规划"],
        answer: "B",
      ...
      },
{
        ...
        options: ["38万元/人", "48万元/人", "58万元/人", "68万元/人"],
        answer: "C",
      ...
      },
{
        ...
        options: ["80.9岁", "82.5岁", "83.9岁", "85.0岁"],
        answer: "C",
      ...
      },
{
        ...
        options: ["朝阳、海淀", "东城、西城", "丰台、石景山", "通州、大兴"],
        answer: "B",
      ...
      },
{
        ...
        options: ["20项指标、50项工程", "29项指标、100项工程", "35项指标、120项工程", "29项指标、50项工程"],
        answer: "B",
